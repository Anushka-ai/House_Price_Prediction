...
setwd("E:\\Rfolder\\house-prices-advanced-regression-techniques-folder")
getwd()
...
write.csv(pred, "t1_prediction.csv")

attach(Final_Data)
Final_Data$pred <- fitted(House_Model_11)
write.csv(Final_Data,"mape_new.csv")->Write_Train
...
par(mfrow = c(2,2))
#plot(House_Model_11)
pred_Test<-predict(House_Model_11, newdata = House_Test, type = "response")
write.csv(pred_Test , "Testnew_Prediction.csv")
attach(House_Test)
